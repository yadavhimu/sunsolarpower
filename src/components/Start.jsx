    ...
    <div className='px-[2vw] '>
      <div className='w-full flex mt-20'>
        <div className='w-full p-4'>
            <p className='text-7xl font-bold text-[#252F38]'>Residential Solar</p>
            <p className='text-7xl font-bold text-[#252F38]'>Panel Installation</p>
            <p className='text-7xl font-bold text-[#252F38]'>Services for Your Home</p>
        ...
        <div className='w-full shadow-2xl'>
            <img src="./images/solar1.jpg" alt="home images" />
        </div>
      </div>
    </div>
  )
