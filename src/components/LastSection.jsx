    ...
    <div className='px-[2vw]'>
      <div className='flex mt-20'>
        <div className='w-full '>
          <p className='text-5xl font-bold text-[#252F38]'>What Should You Consider Before</p>
          <p className='text-5xl font-bold text-[#252F38]'>Installing Home Solar Panels?</p>
          <p className=' text-2xl mt-10'>Here are several factors that you should know to determine whether your home is a good fit for a solar panel installation:</p>
        ...
        <img className='ml-40' src="./images/solar5.jpg" alt="home" />
        </div>
      </div>
    </div>
  )
